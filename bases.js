...
import { initIdeasMarketingSheet, loadIdeasMarketing, migrateOldIdeasToMarketing } from './ideas-marketing.js';
...
async function provisionAllTabs() {
  await Promise.all([
    ...
    initIdeasMarketingSheet().then(migrateOldIdeasToMarketing).then(loadIdeasMarketing),
...
const MODULE_LABELS = {
  ...
  ferias: 'Ventas', stock: 'Stock', informes: 'Informes', qr: 'QR',
  contactos: 'Contactos'
};
