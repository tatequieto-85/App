...
function getStockProducido(recetaId) {
  return ejecuciones
...
async function initStockSheets() {
  const info = await sheetsReq('');
  const tabs = info.sheets || [];
...
async function loadStockTestigos() {
...
function renderStockTrazabilidad() {
...
function renderStockTestigoList() {
