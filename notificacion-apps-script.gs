...
// (El proxy de tokens OAuth que antes vivía acá se reemplazó por un
// Cloudflare Worker — ver worker/README.md en el repo. Este archivo ahora
// solo maneja los recordatorios de WhatsApp, que son independientes.)
