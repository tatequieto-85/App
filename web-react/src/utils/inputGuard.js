// Portado de ../../input-guard.js — sistema anti-clics involuntarios
// (ignora taps fantasma tras un scroll). En móvil, si el usuario desliza el
// dedo y lo levanta sobre un botón/tarjeta, el navegador dispara igual un
// "click" sintético; acá se detecta ese movimiento y se cancela ese click.
// Efecto global de módulo — importar una sola vez (ver main.jsx), no un hook.
...
document.addEventListener('touchend', () => {
  ...
  // Si el click fantasma no llega, hay que desarmar la bandera pronto: si
  // no, se queda "armada" y se come el próximo clic real del usuario.
