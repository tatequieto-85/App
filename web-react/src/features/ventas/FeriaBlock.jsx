...
// usuario: Lugar, Fechas, Precio, Empresa, Persona (contacto) y por último
// los íconos de ventas/pruebas/llevados — todo con íconos de línea, nunca
// emojis (pedido explícito: "no quiero ningún emoji en la app").
